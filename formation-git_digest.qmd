---
title: "Formation digest Git et Gitlab"
...
- **Travailler collectivement** sur les mêmes fichiers **en même temps** => cf. [ici](https://ddotta.github.io/formation-git/#/git---un-mod%C3%A8le-distribu%C3%A9){target="_blank"}    
- Obtenir de **la traçabilité** : on sait qui a changé quoi, quand, comment et pourquoi => cf. [exemple sur l'IPPAP](https://forge.agriculture.rie.gouv.fr/gitlab/ssp/bmis/ippap){target="_blank"}  
...
- **Voyager dans le temps** cf. [ici](https://ddotta.github.io/formation-git/#/revenir-en-arri%C3%A8re-avec-gitlab-13){target="_blank"}  
...
En tant que nouvelle formation au catalogue du MASA, le nombre de places n'est pas limité et un effort pourra être fait sur le nombre de formations dispensées pour répondre au besoin si nécessaire.